...
$(document).ready(function() {
    $('#add').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('superadmin/keuangan/pemasukan/api_add') ?>",
            type: "POST",
...
$(document).on('submit', '#edit', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('superadmin/keuangan/pemasukan/api_edit/') ?>" + form_data.get('id_pemasukan'),
        dataType: "json",
        data: form_data,
        processData: false,
        contentType: false,
...
function hapuspemasukan(id_pemasukan) {
    swal({
        ...
        if (result.value) { // Only delete the data if the user clicked on the confirm button
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('superadmin/keuangan/pemasukan/api_hapus/') ?>" + id_pemasukan,
                dataType: "json",
            }).done(function() {
                swal({
                    title: "Berhasil",
...
$(document).on('submit', '#uploadBukti', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('superadmin/keuangan/pemasukan/api_upload/') ?>" +
                form_data.get(
                    'id_pemasukan'),
            dataType: "json",
            data: form_data,
    ...
    function hapusbuktitransfer(id_pemasukan) {
        swal({
            ...
            if (result
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('superadmin/keuangan/pemasukan/api_hapus_foto/') ?>" +
                        id_pemasukan,
                    dataType: "json",
                }).done(function() {
                    swal({
