                                        ...
                                        <?php if($laporan['id_kegiatan'] == $k['id_kegiatan']): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= site_url('user/keuangan/laporan/detail_pemasukan/'.$laporan['id_kegiatan']) ?>" class="btn btn-info btn-xs">
                                                    <span class="fa fa-eye"></span>
                                                    </a>
                                                </td>
                                                <td>
                                                    <?= rupiah($total_pengeluaran[$laporan['id_kegiatan']]) ?>
                                                    <a href="<?= site_url('user/keuangan/laporan/detail_pengeluaran/'.$laporan['id_kegiatan']) ?>" class="btn btn-info btn-xs">
                                                    <span class="fa fa-eye"></span>
                                                    </a>
                                                </td>
